...
public class OutstandingRebatesReceivable extends Header
{
    private SeleniumMethods com;
    private ApexCommon comm;
    public static String title = PagesTitle.OutstandingRebatesReceivable .title;
    public OutstandingRebatesReceivable () {
        PageFactory.initElements(DriverFactory.getDriver(), this);
        com = new SeleniumMethods();
        comm = new ApexCommon();
    }
    
    @FindBy(xpath="//li[contains(normalize-space(.),'Outstanding Rebates Receivable')][contains(@class,'Breadcrumb')]")
    private WebElement data_OutstandingRebatesReceivable_BreadCrumb;
	...
	private List<String> colNames = new ArrayList<>(
			Arrays.asList("Roaming Partner", "Operator Group", "Agreement Reference Ascending", "Agreement Start Date",
					...
					"Document Amount Incl. Tax", "Outstanding Receivable Incl. Tax",
					"MoM Variance Last Month Incl. Tax"));
    ...
    public void verify_UI(TADIG TADIG, String finYear, String tax_Gross_Net_Both) {
        ...
        com.isElementPresent(data_OutstandingRebatesReceivable_BreadCrumb,"data_Outstanding Rebates Receivable_BreadCrumb");
