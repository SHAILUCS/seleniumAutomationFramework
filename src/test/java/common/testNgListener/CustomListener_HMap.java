...
public class CustomListener_HMap implements ITestListener,IExecutionListener{
	...
	public void onTestStart(ITestResult result) {
		...
		String user = testDataMap.get(TestNGKeys.user);
		if(testDataMap.get(TestNGKeys.environment).toLowerCase().contains("qlik")){
			new QlikLogin().performLogin(user);
		}else{
